...
UINT32 OV5649MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//LINE <> <DATE20131111> <S8513A:add sensor darling ov5648.> wupingzhou
...
UINT32 IMX111_MIPI_DARLING_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //LINE <> <20131021> <add the imx111 darling driver> panzaoyan
...
UINT32 OV5648MIPISensorInit_truly(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HI258_YUV_SensorInit_cmk(PSENSOR_FUNCTION_STRUCT *pfFunc); 
UINT32 HI258_YUV_SensorInit_sw(PSENSOR_FUNCTION_STRUCT *pfFunc); 
//end
//zhangdongfang add 
UINT32 OV8825_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV5648MIPISensorInit_darling_zl(PSENSOR_FUNCTION_STRUCT *pfFunc);
//yixuhong 20141226 add 5301 camera
...
#if defined(OV5648_MIPI_RAW_TRULY)
    {OV5649MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_TRULY, OV5648MIPISensorInit_truly}, 
#endif
...
#if defined(OV5648_MIPI_RAW_DARLING_ZL)
    {OV5648MIPI_SENSOR_ID_DARLING_ZL, SENSOR_DRVNAME_OV5648_MIPI_RAW_DARLING_ZL, OV5648MIPISensorInit_darling_zl}, 
#endif

#if defined(HI258_MIPI_YUV_CMK)
    {HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV_CMK, HI258_YUV_SensorInit_cmk},
#endif
#if defined(HI258_MIPI_YUV_SW) 
    {HI259_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV_SW, HI258_YUV_SensorInit_sw},
#endif
//jzw end
...
#endif
#if defined(OV2680_MIPI_RAW_CMK)
    {OV2680_CMK_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV2680_CMK_MIPI_RAW, OV2680_CMK_MIPISensorInit}, 
#endif
#if defined(OV2680_MIPI_RAW_SUNWIN)
    {OV2680_SUNWIN_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV2680_SUNWIN_MIPI_RAW, OV2680_SUNWIN_MIPISensorInit}, 
#endif
//guomingyi20141115 add end.
...
//guomingyi20141115 add start.
#if defined(LITEON3H7Y_MIPI_RAW)
    {LITEON3H7Y_SENSOR_ID, SENSOR_DRVNAME_LITEON3H7Y_MIPI_RAW, LITEON3H7Y_MIPI_RAW_SensorInit}, 
#endif
//guomingyi20141115 add end.
...
#endif
#if defined(OV5649_MIPI_RAW)//LINE <> <DATE20131111> <S8513A:add sensor darling ov5648.> wupingzhou
    {OV5649MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5649_MIPI_RAW, OV5649MIPISensorInit}, //LINE <> <DATE20131111> <S8513A:add sensor darling ov5648.> wupingzhou
#endif
...
#endif
#if defined(IMX111_MIPI_DARLING)
    {IMX111_DARLING_SENSOR_ID, SENSOR_DRVNAME_IMX111_MIPI_DARLING, IMX111_MIPI_DARLING_SensorInit}, 
#endif
  ...
  {AR0833_SENSOR_ID, SENSOR_DRVNAME_AR0833_MIPI_RAW,AR0833_MIPI_RAW_SensorInit},
    ...
    {HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV, HI258_YUV_SensorInit}, 
#endif
	...
	{GC2355_MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2355_MIPI_RAW, GC2355_MIPI_RAW_SensorInit},
#endif
...
#if defined(S5K3H7Y_MIPI_RAW_S5400)
    {S5K3H7Y_SENSOR_ID, SENSOR_DRVNAME_S5K3H7Y_MIPI_RAW, S5K3H7Y_MIPI_RAW_SensorInit}, 
#endif
...
#if defined(OV5648_MIPI_RAW_SUNWIN)//LINE <> <DATE20140429> <s4700 add sensor:sunwin ov5648> wupingzhou
    {OV5648MIPI_SENSOR_ID_SUNWIN, SENSOR_DRVNAME_OV5648_MIPI_RAW_SUNWIN, OV5648MIPISensorInit_sunwin}, 
#endif

#if defined(OV5648_MIPI_RAW_DARLING_ZL)//LINE <> <DATE20140429> <s4700 add sensor:sunwin ov5648> wupingzhou
   // {LITEON3H7Y_SENSOR_ID, SENSOR_DRVNAME_LITEON3H7Y_MIPI_RAW, LITEON3H7Y_MIPI_RAW_SensorInit},
...
//yixuhong 20141226 add 5301 camera
    ...
    {HI545MIPI_SENSOR_ID, SENSOR_DRVNAME_HI545_RAW, HI545_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV5648_MIPI_RAW_SHUNYU)
    {OV5648MIPI_SENSOR_ID_SHUNYU, SENSOR_DRVNAME_OV5648_MIPI_RAW_SHUNYU, OV5648MIPISensorInit_shunyu}, 
#endif
//yixuhong 20141226 add 5301 camera
...
#if defined(OV5648_MIPI_RAW_SUNWIN_S5400)
    {OV5648MIPI_SENSOR_ID_SUNWIN, SENSOR_DRVNAME_OV5648_MIPI_RAW_SUNWIN, OV5648MIPISensorInit_sunwin}, 
#endif

#if defined(GC0310_MIPI_YUV)
    {GC0310_SENSOR_ID, SENSOR_DRVNAME_GC0310_MIPI_YUV, GC0310MIPI_YUV_SensorInit}, 
#endif
