...
UINT32 OV2680_CMK_MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV2680_SUNWIN_MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//guomingyi20141115 add end.

UINT32 IMX179_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX178_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);  // by zhangxian added line
...
UINT32 HI545_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //LINE <> <20140729> <add the hi258 sunwin camera module> panzaoyan
UINT32 OV5648MIPISensorInit_shunyu(PSENSOR_FUNCTION_STRUCT *pfFunc);
//yixuhong 20141226 add 5301 camera
...
#if defined(OV2680_MIPI_RAW_S5400)
	{OV2680MIPI_SENSOR_ID, SENSOR_DRVNAME_OV2680_SUNWIN_MIPI_RAW, OV2680_SUNWIN_MIPISensorInit}, 
#endif
...
#if defined(OV5648_MIPI_RAW_S5400)
    {OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_DARLING, OV5648MIPISensorInit}, 
#endif
